...
public class OverviewSelectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String delivery = Utilities.makeTimeString(time);
        String alarm = Utilities.makeOffsetStrign(time);

        Address address = Utilities.getAddress(this);
        String street = address.getAddress();

        ((ImageView) findViewById(R.id.overview_selection_image)).setImageResource(image);
        ((TextView) findViewById(R.id.overview_selection_meal)).setText(mealTitle);
        ...
        ((TextView) findViewById(R.id.overview_selection_address)).setText(street);
